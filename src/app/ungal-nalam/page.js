...
const UngalNalamPage = () => {
  ...
  const videos = {
    tamil: [
      { id: 1, title: 'நீரிழிவு நோய் தடுப்பு', channel: 'Health Tamil', views: '1.2M' },
      { id: 2, title: 'ஆரோக்கியமான உணவு முறைகள்', channel: 'Tamil Health Tips', views: '850K' },
      { id: 3, title: 'யோகா மற்றும் தியானம்', channel: 'Wellness Tamil', views: '2.1M' },
      { id: 4, title: 'இதய நோய் விழிப்புணர்வு', channel: 'Medical Tamil', views: '950K' },
      { id: 5, title: 'மன ஆரோக்கியம்', channel: 'Mind Health Tamil', views: '1.5M' },
      { id: 6, title: 'குழந்தைகள் சுகாதாரம்', channel: 'Kids Health Tamil', views: '780K' }
    ],
    english: [
      { id: 1, title: 'Diabetes Prevention Tips', channel: 'Health Channel', views: '2.5M' },
      { id: 2, title: 'Healthy Diet Plans', channel: 'Nutrition Guide', views: '1.8M' },
      { id: 3, title: 'Yoga and Meditation', channel: 'Wellness TV', views: '3.2M' },
      { id: 4, title: 'Heart Disease Awareness', channel: 'Medical Info', views: '1.9M' },
      { id: 5, title: 'Mental Health Matters', channel: 'Mind Wellness', views: '2.7M' },
      { id: 6, title: 'Child Healthcare Guide', channel: 'Kids Health', views: '1.4M' }
    ]
  };
        ...
        <div className="relative z-10 min-h-screen">
          ...
          <div className="p-6">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {videos[selectedLanguage].map((video, index) => (
                <motion.div
                  key={video.id}
