...
const ConsultPage = () => {
  ...
  const [consultStep, setConsultStep] = useState('permission'); // permission, map, hospital, doctor, videocall

  // Mock data - will be replaced with API
  const mockHospitals = [
    { id: 1, name: 'Government General Hospital', distance: '2.3 km', lat: 11.0168, lng: 76.9558, doctors: 5 },
    { id: 2, name: 'Primary Health Centre', distance: '4.1 km', lat: 11.0268, lng: 76.9658, doctors: 3 },
    { id: 3, name: 'District Hospital', distance: '5.8 km', lat: 11.0368, lng: 76.9758, doctors: 8 }
  ];

  const mockDoctors = [
    { id: 1, name: 'Dr. Rajesh Kumar', specialization: 'General Physician', available: true, shift: '9 AM - 5 PM' },
    { id: 2, name: 'Dr. Priya Sharma', specialization: 'Pediatrician', available: true, shift: '10 AM - 6 PM' },
    { id: 3, name: 'Dr. Arun Patel', specialization: 'Cardiologist', available: false, shift: '2 PM - 8 PM' },
    { id: 4, name: 'Dr. Lakshmi Iyer', specialization: 'Gynecologist', available: true, shift: '8 AM - 4 PM' }
  ];
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex-1 overflow-hidden">
                ...
                >
                  <MapComponent userLocation={userLocation} hospitals={mockHospitals} />
                </motion.div>
              ...
              {mockDoctors.map((doctor) => (
                <motion.div
                  ...
                  className={`bg-white/90 backdrop-blur-md rounded-2xl p-6 shadow-lg border-2 ${
                    doctor.available ? 'border-green-200 cursor-pointer hover:shadow-xl' : 'border-gray-200 opacity-60'
                  } transition-all`}
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <span className={`w-2 h-2 rounded-full ${doctor.available ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}></span>
                          <span className="text-xs text-gray-600">
                            {doctor.available ? (language === 'tamil' ? 'கிடைக்கிறது' : 'Available') : (language === 'tamil' ? 'கிடைக்கவில்லை' : 'Unavailable')}
                          </span>
                        </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 flex items-center justify-center">
              ...
              >
                ...
                >
                  ...
                  <span className="text-lg">{language === 'tamil' ? 'வீடியோ அழைப்பைத் தொடங்கு' : 'Start Video Call'}</span>
                </motion.button>
              </motion.div>
            </div>
          </div>
          ...
          <div className="relative z-10 min-h-screen flex flex-col">
            <div className="flex-1 relative">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-32 h-32 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse">
                    <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                  <h2 className="text-2xl font-bold text-white mb-2">{selectedDoctor.name}</h2>
                  <p className="text-gray-400 mb-6">{language === 'tamil' ? 'இணைக்கிறது...' : 'Connecting...'}</p>
                </div>
              </div>

              <div className="absolute top-4 right-4 w-32 h-40 bg-gray-800 rounded-xl border-2 border-green-500 overflow-hidden">
            ...
            <div className="bg-gray-800/90 backdrop-blur-md p-6">
              <div className="flex items-center justify-center gap-6">
                <motion.button
                  className="w-14 h-14 bg-gray-700 rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                >
